...
<body>
<nav class="Hui-breadcrumb"><i class="icon-home"></i> 首页 <span class="c-gray en">&gt;</span> 职位信息管理 <span class="c-gray en">&gt;</span> 前排推广信息 </nav>
<div class="pd-20">
  ...
  <table class="table table-border table-bordered table-hover table-bg">
      ...
      <c:forEach items="${AdList}" var="temp">
       ...
       <td>${temp.fa_id}</td>
       <td>${temp.fa_name}</td>
       <td><a href="${temp.fa_image}" target="_blank">查看图片</a></td>
       <td><a href="${temp.fa_image2}" target="_blank">查看图片</a></td>
       <td>${temp.fa_h_email}</td>
       <td class="f-14 user-manage"><a title="编辑" href="javascript:;" onClick="user_edit('4','550','','编辑','updateAd.do?fa_id=${temp.fa_id}')" class="ml-5" style="text-decoration:none"><i class="icon-edit"></i></a> </td>
      </tr>
      </c:forEach>
      </tbody>
    </table>
