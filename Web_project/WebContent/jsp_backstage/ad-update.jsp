...
var testid = false;
 ...
 function forbid(){
	 var span1 = document.getElementById("fa_image").value
	 var span2 = document.getElementById("fa_image2").value
	 if(span1==""||span2==""){
		 return false;
	 }else {
	 return true;
...
<body>
	<div class="pd-20">
		<div class="Huiform">
			<form action="updateAd2.do" method="post" id="groupform"
				target="_parent" enctype="multipart/form-data" onsubmit="return forbid()">
				<table class="table table-bg">
					<tbody>
						<tr>
							<th class="text-r">ID：</th>
							<td>${fif.fa_id}<input type="hidden" id="faid" name="faid" value="${fif.fa_id}"><span id="error"></span></td>
						</tr>
						<tr>
							<th class="text-r">公司名称：</th>
							<td><input type="text" style="width: 200px"
								class="input-text" placeholder="请输入公司名称" id="fa_name"
								name="fa_name" value="${fif.fa_name}"></td>
						</tr>
						<tr>
							<th class="text-r">大尺寸图片：</th>
							<td><input type="file" name="fa_image" id="fa_image" value="点击上传"></td>
						</tr>
						<tr>
							<th class="text-r">小尺寸图片：</th>
							<td><input type="file" name="fa_image2" id="fa_image2" value="点击上传"></td>
						</tr>
						<tr>
							<th class="text-r">HR帐号：</th>
							<td><input type="text" style="width: 200px"
								class="input-text" placeholder="请输入HR帐号" id="fa_h_email"
								name="fa_h_email" value="${fif.fa_h_email}">(务必确保填写正确)</td>
						</tr>
						<tr>
							<th class="text-r"></th>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
