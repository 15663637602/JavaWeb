	...
	<div class="pd-20">
		<div class="Huiform">
			<form action="updateCode2.do" method="post" id="groupform"
				target="_parent" onsubmit="return forbid()">
				<table class="table table-bg">
					<tbody>
						<tr>
							<th class="text-r">学号：</th>
							<td><input type="text" style="width: 200px"
								class="input-text" value="${rc_no}" id="rc_no" name="rc_no"
								datatype="*2-16" nullmsg="学号不能为空" onblur="testno()"><span
								id="span1"></span></td>
						</tr>
						<tr>
							<th class="text-r">学生姓名：</th>
							<td><input type="text" style="width: 200px"
								class="input-text" placeholder="请输入学生姓名" id="rc_name"
								name="rc_name" datatype="*2-16" nullmsg="学生姓名不能为空"></td>
						</tr>
						<tr>
							<th class="text-r">注册码：</th>
							<td><input type="text" style="width: 200px"
								class="input-text" placeholder="请输入注册码" id="rc_code"
								name="rc_code" datatype="*2-16" nullmsg="注册码不能为空"
								onblur="testcode()"><span id="span2"></span></td>
						</tr>
						<tr>
							<th class="text-r">学院名称：</th>
							<td><input type="text" style="width: 200px"
								class="input-text" placeholder="请输入学院名称" id="rc_college"
								name="rc_college" datatype="*2-16" nullmsg="名称不能为空"></td>
						</tr>
						<tr style="display: none">
							<th class="text-r">xuehao：</th>
							<td><input type="text" style="width: 200px"
								class="input-text" id="rc_multiple"
								name="rc_multiple" value="${rc_no}"></td>
						</tr>
						<tr style="display: none">
							<th class="text-r">id：</th>
							<td><input type="text" style="width: 200px"
								class="input-text" id="rc_id"
								name="rc_id" value="${rc_id}"></td>
						</tr>
						<tr>
							<th class="text-r"></th>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
