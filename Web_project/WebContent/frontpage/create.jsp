	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			<li><a href="myhome.do?name=${sessionScope.username}">公司</a></li>	    							    			<li class="current"><a rel="nofollow" href="create.do?name=${sessionScope.username}">发布职位</a></li>
   ...
   <div class="f24">123456789</div>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	<div class="ccc_tr">已发布 <span>0</span> 个职位  </div>
                    	<form action="createJob.do?name=${sessionScope.username}" method="post" id="jobFormss">
                            ...
                            <table class="btm">
                            	...
                            	<tr>
                                	...
                                	<td>
                                        ...
                                        <textarea placeholder="" name="JobProfile" id="JobProfile"></textarea>	
                                ...
                                <tr>
                                	...
                                	<td>职位要求</td>
                                	<td>
                                       	<textarea placeholder="" name="JobDemand" id="JobDemand"></textarea>
                                    </td>
                                </tr>
                                <!-- <tr>
                                	<td><span class="redstar">*</span></td>
                            ...
                            <table>
                                ...
                                <tr>
                                	...
                                	<td colspan="2">
                                    	联系方式
                                       <input type="text" placeholder="请输入联系方式"  name="contactInfo" class="input_520" id="contactInfo">
                                    </td>
                                </tr>
                                <tr>
                                	<td width="25"></td>
