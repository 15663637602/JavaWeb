...
<ul class="hot_pos reset">
	            ...
	            <li class="clearfix">
		      		         	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="stu_showjob.do?p_id=${temp.p_id}&h_email=${temp.h_email}" target="_blank">${temp.p_name}</a> 
			                            &nbsp;
			                            <span class="c9">[${temp.p_loc}]</span>
			                            			                        </div>
			                        <span><em class="c7">月薪： </em>${temp.p_low_salary}k-${temp.p_high_salary}k</span>
			                        <span><em class="c7">类别：</em> ${temp.p_field}</span>
			                        <span><em class="c7">最低学历： </em>${temp.p_degree}</span>
			                        <br />
			                        <span><em class="c7">职位诱惑：</em>${temp.p_charm}</span>
			                        <br />
			                        <!-- <a  class="wb">分享到微博</a> -->
			                    </div>
			                	<div class="hot_pos_r">
			                    	<div class="mb10 recompany"><a href="stu_showcom.do?h_email=${temp.h_email}" target="_blank">${temp.p_company}</a></div>
			                        <span><em class="c7">领域：</em> ${temp.p_fields}</span>
			                        			                        <span><em class="c7">阶段：</em>${temp.p_stage}</span>
			                        			                        <br />
			                        <span><em class="c7">规模：</em>${temp.p_pop}</span>
			                    </div>
			              </li>
			              <hr>
	            </c:forEach>
	             ...
	             <a href="stu_login.jsp" class="btn fr">查看更多</a>
	 <%}else{ %>           
	 <div id="hotList">
	 <ul class="hot_pos reset">
	          <c:forEach items="${PositionList}" var="temp">
	            <li class="clearfix">
		      		         	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="stus_showjob.do?p_id=${temp.p_id}&h_email=${temp.h_email}&name=${sessionScope.username}" target="_blank">${temp.p_name}</a> 
			                            &nbsp;
			                            <span class="c9">[${temp.p_loc}]</span>
			                            			                        </div>
			                        <span><em class="c7">月薪： </em>${temp.p_low_salary}k-${temp.p_high_salary}k</span>
