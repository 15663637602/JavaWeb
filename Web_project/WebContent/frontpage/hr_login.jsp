...
<body id="login_bg">
	<div class="login_wrapper">
    	...
    	<input type="hidden" id="resubmitToken" value="" />		
		 <div class="login_box">
        	<form id="loginForm" action="hr_login.do" onsubmit="return tijiao()">
        	<span class="error" id="error">${error}</span>
				<input type="text" id="email" name="email" value="" tabindex="1" placeholder="请输入登录邮箱地址" onblur="displaya()"/>
			    ...
			    <a href="reset_hr.jsp" class="fr" target="_blank">忘记密码？</a>
