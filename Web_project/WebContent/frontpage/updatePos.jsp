...
<meta name="description" content="发布职位">
<meta name="keywords" content="发布职位">
...
function type(String){
	document.getElementById("positionType").value = String;
	document.getElementById("positionName").value = "";
}
function name(String,type){
	document.getElementById("positionName").value = String;
	document.getElementById("positionType").value = type;
}
function edu(String){
	document.getElementById("education").value = String;
}
</script>
</head>
<body>
<div id="body">
	...
	<dd>
		<a href="onInterview.jsp">已通知面试简历</a>
	</dd>
	<dd>
...
<div class="subscribe_side mt20">
   <div class="f14">加入HR交流群</div>
   <div class="f18 mb10">跟同行聊聊</div>
   <div class="f24">123456789</div>
</div>            </div><!-- end .sidebar -->
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	<form action="updateJob.do?name=${sessionScope.username}&id=${pif_Info.p_id}" method="post" id="jobFormss">
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">职位类别</td>
                                	<td>
                                    	<input type="hidden" id="positionType"  name="positionType" value="${pif_Info.p_field}">
                                        <input type="button" value="${pif_Info.p_field}" id="select_category" class="selectr selectr_380">                                      
                                        <div class="dn" id="box_job" style="display: none;">
                                                    ...
                                                    <dd>
                                                        <ul class="reset job_main">
                                                                                                                            <li>
                                                                    <span onclick="type('后端开发')">后端开发</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('Java','后端开发')">Java</li>
                                                                                                                                                    <li onclick="name('C++','后端开发')">C++</li>
                                                                                                                                                    <li onclick="name('PHP','后端开发')">PHP</li>
                                                                                                                                                    <li onclick="name('数据挖掘','后端开发')">数据挖掘</li>
                                                                                                                                                    <li onclick="name('C','后端开发')">C</li>
                                                                                                                                                    <li onclick="name('C#','后端开发')">C#</li>
                                                                                                                                                    <li onclick="name('.NET','后端开发')">.NET</li>
                                                                                                                                                    <li onclick="name('Hadoop','后端开发')">Hadoop</li>
                                                                                                                                                    <li onclick="name('Python','后端开发')">Python</li>
                                                                                                                                                    <li onclick="name('Delphi','后端开发')">Delphi</li>
                                                                                                                                                    <li onclick="name('VB','后端开发')">VB</li>
                                                                                                                                                    <li onclick="name('Perl','后端开发')">Perl</li>
                                                                                                                                                    <li onclick="name('Ruby','后端开发')">Ruby</li>
                                                                                                                                                    <li onclick="name('Node.js','后端开发')">Node.js</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('移动开发')">移动开发</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                                                                                                    <li onclick="name('HTML5','移动开发')">HTML5</li>
                                                                                                                                                    <li onclick="name('Android','移动开发')">Android</li>
                                                                                                                                                    <li onclick="name('iOS','移动开发')">iOS</li>
                                                                                                                                                    <li onclick="name('WP','移动开发')">WP</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('前端开发')">前端开发</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                                                                                                    <li onclick="name('web前端','前端开发')">web前端</li>
                                                                                                                                                    <li onclick="name('Flash','前端开发')">Flash</li>
                                                                                                                                                    <li onclick="name('html5','前端开发')">html5</li>
                                                                                                                                                    <li onclick="name('JavaScript','前端开发')">JavaScript</li>
                                                                                                                                                    <li onclick="name('U3D','前端开发')">U3D</li>
                                                                                                                                                    <li onclick="name('COCOS2D-X','前端开发')">COCOS2D-X</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('测试')">测试</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('测试工程师','测试')">测试工程师</li>
                                                                                                                                                    <li onclick="name('自动化测试','测试')">自动化测试</li>
                                                                                                                                                    <li onclick="name('功能测试','测试')">功能测试</li>
                                                                                                                                                    <li onclick="name('性能测试','测试')">性能测试</li>
                                                                                                                                                    <li onclick="name('测试开发','测试')">测试开发</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('运维')">运维</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                                                                                                    <li onclick="name('运维工程师','运维')">运维工程师</li>
                                                                                                                                                    <li onclick="name('运维开发工程师','运维')">运维开发工程师</li>
                                                                                                                                                    <li onclick="name('网络工程师','运维')">网络工程师</li>
                                                                                                                                                    <li onclick="name('系统工程师','运维')">系统工程师</li>
                                                                                                                                                    <li onclick="name('IT支持','运维')">IT支持</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('DBA')">DBA</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                                                                                                    <li onclick="name('MySQL','DBA')">MySQL</li>
                                                                                                                                                    <li onclick="name('SQLServer','DBA')">SQLServer</li>
                                                                                                                                                    <li onclick="name('Oracle','DBA')">Oracle</li>
                                                                                                                                                    <li onclick="name('DB2','DBA')">DB2</li>
                                                                                                                                                    <li onclick="name('MongoDB','DBA')">MongoDB</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('项目管理')">项目管理</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('项目经理','项目管理')">项目经理</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('高端技术职位')">高端技术职位</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                                                                                                    <li onclick="name('技术经理','高端技术职位')">技术经理</li>
                                                                                                                                                    <li onclick="name('技术总监','高端技术职位')">技术总监</li>
                                                                                                                                                    <li onclick="name('测试经理','高端技术职位')">测试经理</li>
                                                                                                                                                    <li onclick="name('架构师','高端技术职位')">架构师</li>
                                                                                                                                                    <li onclick="name('CTO','高端技术职位')">CTO</li>
                                                                                                                                                    <li onclick="name('运维总监','高端技术职位')">运维总监</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                    </ul>
                                                    </dd>
                                                    ...
                                                    <dd>
                                                        <ul class="reset job_main">
                                                                                                                            <li>
                                                                    <span onclick="type('产品经理')">产品经理</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('产品经理','产品经理')">产品经理</li>
                                                                                                                                                    <li onclick="name('网页产品经理','产品经理')">网页产品经理</li>
                                                                                                                                                    <li onclick="name('移动产品经理','产品经理')">移动产品经理</li>
                                                                                                                                                    <li onclick="name('产品助理','产品经理')">产品助理</li>
                                                                                                                                                    <li onclick="name('数据产品经理','产品经理')">数据产品经理</li>
                                                                                                                                                    <li onclick="name('电商产品经理','产品经理')">电商产品经理</li>
                                                                                                                                                    <li onclick="name('游戏策划','产品经理')">游戏策划</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('产品设计师')">产品设计师</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                                                                                                    <li onclick="name('网页产品设计师','产品设计师')">网页产品设计师</li>
                                                                                                                                                    <li onclick="name('无线产品设计师','产品设计师')">无线产品设计师</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('高端产品职位')">高端产品职位</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                                                                                                    <li onclick="name('产品部经理','高端产品职位')">产品部经理</li>
                                                                                                                                                    <li onclick="name('产品总监','高端产品职位')">产品总监</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                    </ul>
                                                    </dd>
                                                    ...
                                                    <dd>
                                                        <ul class="reset job_main">
                                                                                                                            <li>
                                                                    <span onclick="type('视觉设计')">视觉设计</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('视觉设计师','视觉设计')">视觉设计师</li>
                                                                                                                                                    <li onclick="name('网页设计师','视觉设计')">网页设计师</li>
                                                                                                                                                    <li onclick="name('Flash设计师','视觉设计')">Flash设计师</li>
                                                                                                                                                    <li onclick="name('APP设计师','视觉设计')">APP设计师</li>
                                                                                                                                                    <li onclick="name('UI设计师','视觉设计')">UI设计师</li>
                                                                                                                                                    <li onclick="name('平面设计师','视觉设计')">平面设计师</li>
                                                                                                                                                    <li onclick="name('美术设计师（2D/3D）','视觉设计')">美术设计师（2D/3D）</li>
                                                                                                                                                    <li onclick="name('广告设计师','视觉设计')">广告设计师</li>
                                                                                                                                                    <li onclick="name('多媒体设计师','视觉设计')">多媒体设计师</li>
                                                                                                                                                    <li onclick="name('原画师','视觉设计')">原画师</li>
                                                                                                                                                    <li onclick="name('游戏特效','视觉设计')">游戏特效</li>
                                                                                                                                                    <li onclick="name('游戏界面设计师','视觉设计')">游戏界面设计师</li>
                                                                                                                                                    <li onclick="name('游戏场景','视觉设计')">游戏场景</li>
                                                                                                                                                    <li onclick="name('游戏角色','视觉设计')">游戏角色</li>
                                                                                                                                                    <li onclick="name('游戏动作','视觉设计')">游戏动作</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('交互设计')">交互设计</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                                                                                                    <li onclick="name('交互设计师','交互设计')">交互设计师</li>
                                                                                                                                                    <li onclick="name('无线交互设计师','交互设计')">无线交互设计师</li>
                                                                                                                                                    <li onclick="name('网页交互设计师','交互设计')">网页交互设计师</li>
                                                                                                                                                    <li onclick="name('硬件交互设计师','交互设计')">硬件交互设计师</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('用户研究')">用户研究</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                                                                                                    <li onclick="name('数据分析师','用户研究')">数据分析师</li>
                                                                                                                                                    <li onclick="name('用户研究员','用户研究')">用户研究员</li>
                                                                                                                                                    <li onclick="name('游戏数值策划','用户研究')">游戏数值策划</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('高端设计职位')">高端设计职位</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('设计经理/主管','高端设计职位')">设计经理/主管</li>
                                                                                                                                                    <li onclick="name('设计总监','高端设计职位')">设计总监</li>
                                                                                                                                                    <li onclick="name('视觉设计经理/主管','高端设计职位')">视觉设计经理/主管</li>
                                                                                                                                                    <li onclick="name('视觉设计总监','高端设计职位')">视觉设计总监</li>
                                                                                                                                                    <li onclick="name('交互设计经理/主管','高端设计职位')">交互设计经理/主管</li>
                                                                                                                                                    <li onclick="name('交互设计总监','高端设计职位')">交互设计总监</li>
                                                                                                                                                    <li onclick="name('用户研究经理/主管','高端设计职位')">用户研究经理/主管</li>
                                                                                                                                                    <li onclick="name('用户研究总监','高端设计职位')">用户研究总监</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                    </ul>
                                                    </dd>
                                                    ...
                                                    <dd>
                                                        <ul class="reset job_main">
                                                                                                                            <li>
                                                                    <span onclick="type('运营')">运营</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('用户运营','运营')">用户运营</li>
                                                                                                                                                    <li onclick="name('产品运营','运营')">产品运营</li>
                                                                                                                                                    <li onclick="name('数据运营','运营')">数据运营</li>
                                                                                                                                                    <li onclick="name('内容运营','运营')">内容运营</li>
                                                                                                                                                    <li onclick="name('活动运营','运营')">活动运营</li>
                                                                                                                                                    <li onclick="name('商家运营','运营')">商家运营</li>
                                                                                                                                                    <li onclick="name('品类运营','运营')">品类运营</li>
                                                                                                                                                    <li onclick="name('游戏运营','运营')">游戏运营</li>
                                                                                                                                                    <li onclick="name('网络推广','运营')">网络推广</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('编辑')">编辑</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                                                                                                    <li onclick="name('副主编','编辑')">副主编</li>
                                                                                                                                                    <li onclick="name('内容编辑','编辑')">内容编辑</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('客服')">客服</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                                                                                                    <li onclick="name('售前咨询','客服')">售前咨询</li>
                                                                                                                                                    <li onclick="name('售后客服','客服')">售后客服</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('高端运营职位')">高端运营职位</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('主编','高端运营职位')">主编</li>
                                                                                                                                                    <li onclick="name('运营总监','高端运营职位')">运营总监</li>
                                                                                                                                                    <li onclick="name('COO','高端运营职位')">COO</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                    </ul>
                                                    </dd>
                                                    ...
                                                    <dd>
                                                        <ul class="reset job_main">
                                                                                                                            <li>
                                                                    <span onclick="type('市场/营销')">市场/营销</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('市场营销','市场/营销')">市场营销</li>
                                                                                                                                                    <li onclick="name('市场策划','市场/营销')")">市场策划</li>
                                                                                                                                                    <li onclick="name('市场顾问','市场/营销')")">市场顾问</li>
                                                                                                                                                    <li onclick="name('市场推广','市场/营销')")">市场推广</li>
                                                                                                                                                    <li onclick="name('SEO','市场/营销')")">SEO</li>
                                                                                                                                                    <li onclick="name('SEM','市场/营销')")">SEM</li>
                                                                                                                                                    <li onclick="name('商务渠道','市场/营销')")">商务渠道</li>
                                                                                                                                                    <li onclick="name('商业数据分析','市场/营销')")">商业数据分析</li>
                                                                                                                                                    <li onclick="name('活动策划','市场/营销')")">活动策划</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('公关')">公关</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                                                                                                    <li onclick="name('媒介经理','公关')">媒介经理</li>
                                                                                                                                                    <li onclick="name('广告协调','公关')">广告协调</li>
                                                                                                                                                    <li onclick="name('品牌公关','公关')">品牌公关</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('销售')">销售</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                                                                                                    <li onclick="name('销售专员','销售')">销售专员</li>
                                                                                                                                                    <li onclick="name('销售经理','销售')">销售经理</li>
                                                                                                                                                    <li onclick="name('客户代表','销售')">客户代表</li>
                                                                                                                                                    <li onclick="name('大客户代表','销售')">大客户代表</li>
                                                                                                                                                    <li onclick="name('BD经理','销售')">BD经理</li>
                                                                                                                                                    <li onclick="name('商务渠道','销售')">商务渠道</li>
                                                                                                                                                    <li onclick="name('渠道销售','销售')">渠道销售</li>
                                                                                                                                                    <li onclick="name('代理商销售','销售')">代理商销售</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('高端市场职位')">高端市场职位</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('市场总监','高端市场职位')">市场总监</li>
                                                                                                                                                    <li onclick="name('销售总监','高端市场职位')">销售总监</li>
                                                                                                                                                    <li onclick="name('商务总监','高端市场职位')">商务总监</li>
                                                                                                                                                    <li onclick="name('CMO','高端市场职位')">CMO</li>
                                                                                                                                                    <li onclick="name('公关总监','高端市场职位')">公关总监</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                    </ul>
                                                    </dd>
                                                    ...
                                                    <dd>
                                                        <ul class="reset job_main">
                                                                                                                            <li>
                                                                    <span onclick="type('人力资源')">人力资源</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('人力资源','人力资源')">人力资源</li>
                                                                                                                                                    <li onclick="name('招聘','人力资源')">招聘</li>
                                                                                                                                                    <li onclick="name('HRBP','人力资源')">HRBP</li>
                                                                                                                                                    <li onclick="name('人事/HR','人力资源')">人事/HR</li>
                                                                                                                                                    <li onclick="name('培训经理','人力资源')">培训经理</li>
                                                                                                                                                    <li onclick="name('薪资福利经理','人力资源')">薪资福利经理</li>
                                                                                                                                                    <li onclick="name('绩效考核经理','人力资源')">绩效考核经理</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('行政')">行政</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                                                                                                    <li onclick="name('助理','行政')">助理</li>
                                                                                                                                                    <li onclick="name('前台','行政')">前台</li>
                                                                                                                                                    <li onclick="name('法务','行政')">法务</li>
                                                                                                                                                    <li onclick="name('行政','行政')">行政</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('财务')">财务</span>
                                                                                                                                        <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                                                                                                    <li onclick="name('会计','财务')">会计</li>
                                                                                                                                                    <li onclick="name('出纳','财务')">出纳</li>
                                                                                                                                                    <li onclick="name('财务','财务')">财务</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                            <li>
                                                                    <span onclick="type('高端职能职位')">高端职能职位</span>
                                                                                                                                        <ul class="reset job_sub dn">
                                                                                                                                                    <li onclick="name('行政总监/经理','高端职能职位')">行政总监/经理</li>
                                                                                                                                                    <li onclick="name('财务总监/经理','高端职能职位')">财务总监/经理</li>
                                                                                                                                                    <li onclick="name('HRD/HRM','高端职能职位')">HRD/HRM</li>
                                                                                                                                                    <li onclick="name('CFO','高端职能职位')">CFO</li>
                                                                                                                                            </ul>
                                                                                                                                    </li>
                                                                                                                    </ul>
                                                    </dd>
                            	...
                            	<tr>
                                	...
                                	<td>职位名称</td>
                                	<td>
                                    	<input type="text" placeholder="请输入职位名称，如：产品经理" name="positionName" id="positionName" value="${pif_Info.p_name}">
                                    	                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td>
                                    	<ul class="profile_radio clearfix reset">
                                    		                                                                                                          <li>
                                                           全职<em></em>
                                                           <input type="radio" name="jobNature" id="jobNature" value="全职"> 
                                                       </li>
                                                                                                                                                                                                         <li>
                                                           兼职<em></em>
                                                           <input type="radio" name="jobNature" id="jobNature" value="兼职"> 
                                                       </li>
                                                                                                                                                                                                         <li>
                                                           实习<em></em>
                                                           <input type="radio" name="jobNature" id="jobNature" value="实习"> 
                                                       </li>
                                                                                                                                       </ul>
                                    </td>
                                </tr>
                            	<tr>
                                	...
                                	<td>
                                    	<div class="salary_range">
                                            <div>
                                                <input type="text" placeholder="最低月薪" value="${pif_Info.p_low_salary}" id="salaryMin" name="salaryMin"> 
                                                <span>k</span>
                                            </div>
                                            <div>
                                                <input type="text" placeholder="最高月薪" value="${pif_Info.p_high_salary}" id="salaryMax" name="salaryMax"> 
                                                <span>k</span>
                                            </div>
                            	...
                            	<tr>
                                	...
                                	<td>工作城市</td>
                                	<td>
                                    	<input type="text" placeholder="请输入工作城市，如：北京" value="${pif_Info.p_loc}" name="workAddress" id="workAddress">
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	...
                            	<tr>
                                    ...
                                    <!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> -->
                                	<td>
                                    	<input type="hidden" id="education" value="${pif_Info.p_degree}" name="education">
                                        <input type="button" value="${pif_Info.p_degree}" id="select_education" class="selectr selectr_380">                                      
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">职位诱惑</td>
                                	<td>
                                    	<input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等"  name="positionAdvantage" class="input_520" id="positionAdvantage" value="${pif_Info.p_charm}">
                                    </td>
                                </tr>
                            	<tr>
                                	<td><span class="redstar">*</span></td>
                                	...
                                	<td>
                                        ...
                                        <textarea  name="JobProfile" id="JobProfile" >${pif_Info.p_descr}</textarea>	
                                ...
                                <tr>
                                	...
                                	<td>职位要求</td>
                                	<td>
                                       	<textarea placeholder="" name="JobDemand" id="JobDemand">${pif_Info.p_demand}</textarea>
                                    </td>
                                </tr>
                                <!-- <tr>
                                	<td><span class="redstar">*</span></td>
                            ...
                            <table>
                                ...
                                <tr>
                                	...
                                	<td colspan="2">
                                    	联系方式
                                       <input type="text" placeholder="请输入联系方式"  name="contactInfo" class="input_520" id="contactInfo" value="${pif_Info.p_contact}">
                                    </td>
                                </tr>
                                <tr>
                                	<td width="25"></td>
                                	<td colspan="2">
                                    	<input type="submit" value="提交" id="formSubmit" class="btn_32">
                                    </td>
                                </tr>
                         	</tbody></table>
                        </form>
