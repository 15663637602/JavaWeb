	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
                ...
                <li class="current"><a href="positions.do?name=${sessionScope.username}">职位管理</a></li>
	    	</ul>
            	...
            	<dl class="company_center_content">
                    ...
                    <dd>
			                	...
			                	<ul class="reset my_jobs">
				                			                            	<li data-id="149594">
		                                    <h3>
		                                        <a href="showJob.do?name=${sessionScope.username}&id=${temp.p_id}">${temp.p_name}</a> 
		                                        <span>[${temp.p_loc}]</span>
		                                  			                                    ...
		                                  			                                    <div>${temp.p_type} / ${temp.p_low_salary}k-${temp.p_high_salary}k /${temp.p_degree}</div>
		                                    		                                    				                                    <div class="c9">发布时间： ${temp.date}</div>
			                                    		                                    		                                    		                                    <div class="links">
		                                       	<a class="job_edit" href="updatePos.do?id=${temp.p_id}&name=${sessionScope.username}">编辑</a>
		                                        <a class="job_del" href="deletePos.do?id=${temp.p_id}&name=${sessionScope.username}">删除</a>
		                                    </div>
		                                    		                                </li>
	                            </ul>
	                            </c:forEach>
