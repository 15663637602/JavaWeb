                    	...
                    	<div class="delivery_tabs">
                    		<ul class="reset">
                    			...
                    			<li id="un">
                    	         ...
                    	         <c:forEach items="${Stu_delivery}" var="temp">               
                            <ul class="reset my_delivery">
                               	                             	<li>
                             		<div class="d_item">
                             			 	                                    <h2 title="${temp.p_name}">
	                                        <a target="_blank" href="showJob.do?name=${temp.h_email}&id=${temp.p_id}">
	                                        	<em>${temp.p_name}</em> 
	                                        	<span>（${temp.p_low_salary}k-${temp.p_high_salary}k）</span>
	                                        	<!--  -->
	                                    	</a>
	                                    </h2>
	                                    		                                <div class="clear"></div>
	                                   	<a title="公司名称" class="d_jobname" href="stu_showcom.do?h_email=${temp.h_email}" target="_blank">
	                                   		${temp.p_company} <span>[${temp.p_loc}]</span> 
	                                    </a>
	                                    <span class="d_time">${temp.date}</span>
	                                    <div class="clear"></div>
                               			...
                               			<ul class="status_list">
                               				    <li class="top">
                               					<div class="list_time"><em></em>HR反馈信息</div>
                               					<div class="list_body">
                               						                               							简历被标记为${temp.status}<div>${temp.message}</div>                               						                               					</div>
                               				</li>
                               				                               			</ul>
