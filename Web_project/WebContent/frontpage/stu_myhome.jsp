...
if(status==null){%>
	    	...
	    	<ul id="navheader" class="reset">
    			<li class="current"><a href="indexshow.do">首页</a></li>
    			<li><a href="positionshow.do">职位</a></li>
					                    ...
					                    <dd>
					                        <form method="post" class="productFormss" action="updatePro.do?name=${sessionScope.username}">
					                            ...
					                            <div class="cp_intro">
					                                ...
					                                <textarea placeholder="请简短描述该产品定位、产品特色、用户群体等" maxlength="500"  class="s_textarea" name="productProfile" id="productProfile"></textarea>	
					                                <div class="word_count fr">限 <span>500</span> 字</div>
					                                <div class="clear"></div>
...
if(name==null){%> 
      	<dl id="noJobs" class="c_section">
		                    ...
		                    <dd>
		                    	<div class="addnew">
		                        	<table>
		                        	<c:forEach items="${pos_info}" var="temps" end="1">
		                     <tr><td>       <a href="stu_showjob.do?p_id=${temps.p_id}&h_email=${temps.h_email}" target="_blank">${temps.p_name}</a></td> 
		                           </c:forEach>
		                            </table>
		           <a href="stu_positions.do?name=${hr_info.h_email}">                 更多职位</a>
		                        </div>
		                    </dd>
		                </dl>
	<%}else{ %>    
	<dl id="noJobs" class="c_section">
		                    ...
		                    <dd>
		                    	<div class="addnew">
		                        	<table>
		                        	<c:forEach items="${pos_info}" var="temps" end="1">
		                     <tr><td>       <a href="stus_showjob.do?p_id=${temps.p_id}&h_email=${temps.h_email}&name=${sessionScope.username}" target="_blank">${temps.p_name}</a></td> 
		                           </c:forEach>
		                            </table>
		           <a href="stu_positions.do?name=${hr_info.h_email}">                 更多职位</a>
		                        </div>
			       					...
			       					<div class="member_wrap">
		                        		...
		                        		<div class="member_info newMember dn" id="contact1">
			                        		<form class="memberFormss" action="updateContact.do?name=${sessionScope.username}" method="post">
						                        <input type="text" placeholder="请输入联系人姓名" id="name" name="name">	
