...
<div id="body">
	<div id="header">
    	<div class="wrapper">
    		<a class="logo" >
    			<img width="229" height="43" alt="职位" src="style/images/logo.png">
    		</a>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    <dt>
                        <h1>
                            <em></em>
                           有效职位 <span>（共<i style="color:#fff;font-style:normal" id="positionNumber">${list_size}</i>个）</span>                        </h1>
                    </dt>
                    <dd>
                    		                    	<form id="searchForm">
...
if(name==null){%>   		
			                	...
			                	<ul class="reset my_jobs">
		                                    ...
		                                    <h3>
		                                        ...
		                                        <span>[${temp.p_loc}]</span>
		                                        						                        		                                    </h3>
		                                    		                                  		<span class="receivedResumeNo"><a>${temp.p_field}</a></span>
		                                  			                                    <div>${temp.p_type} / ${temp.p_low_salary}k-${temp.p_high_salary}k /${temp.p_degree}</div>
		                                    		                                    				                                    <div class="c9">发布时间： ${temp.date}</div>
			                                    		                                    		                                    		                                    <div class="links">
		                                    </div>
		                                    		                                </li>
	                            </ul>
