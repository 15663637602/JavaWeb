...
function oldpass(){
	var stu_id = document.getElementById("Stuname").innerText;
	var pass = document.getElementById("oldpassword").value;
	createRequest();
	var t = new Date();
	req.open("POST","teststu_pass.do?id="+stu_id+"&time="+t.getTime(),true); 
...
<div id="body">
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
     	        <dt><h3>帐号设置</h3></dt>
        <dd><a class="hover" href="stu_updatePwd.jsp">修改密码</a></dd>
            </dl>
</div>
<input type="hidden" id="hasSidebar" value="1">	<div class="content user_modifyContent">
        <dl class="c_section">
            ...
            <dd>
            	            	<form id="updatePswForms" action="stu_updatepass.do" onsubmit="return cancel()">
